          ...
          <div class="checkout-row">
            <div class="payment-box border-right">
              ...
              <div class="mt-10">
                <TextField
                  placeholder="Title *"
                  class="border-global-text-field"
                />
                <TextField
                  placeholder="Brief description *"
                  class="border-global-text-field mt-3"
                />
              </div>
            </div>
            ...
            <div>
              <div class="payment-box">
                <div class="mt-10">
                  <p>Add tags to describe your type of post.</p>
                  <v-combobox
                    ...
                    chips
                  ></v-combobox>
                  <Button type="primary">Publish now</Button>
                  <Button type="bordered">Save as draft</Button>
                </div>
              </div>
